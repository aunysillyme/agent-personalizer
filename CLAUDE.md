...
- Byte fidelity is a promise this tool makes. A change to `render/render.cjs` that alters anything outside the marker block, follows a symlink, or writes before the whole plan is validated will be refused in review.
