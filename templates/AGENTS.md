...
- Evidence before assertion. `[owner: rules/10-evidence-before-assertion.md]`
- One owner per rule. `[owner: rules/20-one-owner-per-rule.md]`
- The folder index is part of the change. `[owner: rules/30-folder-index-is-part-of-the-change.md]`
- Sign every edit. `[owner: rules/40-sign-every-edit.md]`
